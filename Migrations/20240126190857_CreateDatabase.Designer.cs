...
namespace BD_VOLVO.Migrations
{
    ...
    [Migration("20240126190857_CreateDatabase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BD_VOLVO.Model.ClienteConta", b =>
                {
            ...
            modelBuilder.Entity("BD_VOLVO.Model.ClienteReserva", b =>
                {
            ...
            modelBuilder.Entity("BD_VOLVO.Model.Consumo", b =>
                {
            ...
            modelBuilder.Entity("BD_VOLVO.Model.Efetua", b =>
                {
                    b.Property<int>("fkClienteContaIdCliente")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BD_VOLVO.Model.Filial", b =>
                {
            ...
            modelBuilder.Entity("BD_VOLVO.Model.Frigobar", b =>
                {
            ...
            modelBuilder.Entity("BD_VOLVO.Model.Funcionario", b =>
                {
            ...
            modelBuilder.Entity("BD_VOLVO.Model.Pagamento", b =>
                {
            ...
            modelBuilder.Entity("BD_VOLVO.Model.Quarto", b =>
                {
            ...
            modelBuilder.Entity("BD_VOLVO.Model.Reserva", b =>
                {
            ...
            modelBuilder.Entity("BD_VOLVO.Model.Restaurante", b =>
                {
            ...
            modelBuilder.Entity("BD_VOLVO.Model.Servicos", b =>
                {
            ...
            modelBuilder.Entity("BD_VOLVO.Model.Telefone", b =>
                {
            ...
            modelBuilder.Entity("BD_VOLVO.Model.TipoQuarto", b =>
                {
            ...
            modelBuilder.Entity("BD_VOLVO.Model.ClienteReserva", b =>
                {
                    b.HasOne("BD_VOLVO.Model.Reserva", "Reserva")
                        .WithMany()
                        .HasForeignKey("fkReservaIdReserva")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BD_VOLVO.Model.ClienteConta", "ClienteConta")
                        .WithMany()
            ...
            modelBuilder.Entity("BD_VOLVO.Model.Consumo", b =>
                {
                    b.HasOne("BD_VOLVO.Model.Frigobar", "Frigobar")
                        .WithMany()
                        .HasForeignKey("fkFrigobar");

                    b.HasOne("BD_VOLVO.Model.Restaurante", "Restaurante")
                        .WithMany()
                        .HasForeignKey("fkRestaurante");

                    b.HasOne("BD_VOLVO.Model.Servicos", "Servico")
                        .WithMany()
            ...
            modelBuilder.Entity("BD_VOLVO.Model.Efetua", b =>
                {
                    b.HasOne("BD_VOLVO.Model.Pagamento", "Pagamento")
                        .WithMany()
            ...
            modelBuilder.Entity("BD_VOLVO.Model.Frigobar", b =>
                {
                    b.HasOne("BD_VOLVO.Model.Filial", "Filial")
                        .WithMany()
            ...
            modelBuilder.Entity("BD_VOLVO.Model.Quarto", b =>
                {
                    ...
                    b.HasOne("BD_VOLVO.Model.TipoQuarto", "TipoQuarto")
                        .WithMany()
            ...
            modelBuilder.Entity("BD_VOLVO.Model.Reserva", b =>
                {
                    b.HasOne("BD_VOLVO.Model.Funcionario", "Funcionario")
                        .WithMany()
